...
const Requests = () => {
  ...
  return (
    <div>
      ...
      {showForm && storeId && (
        <Card className="mb-6 border border-amber-200 dark:border-amber-800/40 bg-amber-50/60 dark:bg-amber-950/30 shadow-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-lg">
